...
import { maestro, padre_tipo_parentesco } from "@prisma/client";

type MatriculaFormProps = {
  licenciados: maestro[]; // Recibirá la lista de licenciados
};
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <InputField label="Lugar y Fecha de Nacimiento" name="fecha_de_nacimiento" type="date" register={register("fecha_de_nacimiento")} error={errors.fecha_de_nacimiento} />
